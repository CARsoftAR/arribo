...
class GtfsRealtimeTransitService implements TransitService {
  ...
  List<TransitVehicle> _parseFeedMessage(
    ...
    for (final entity in feed.entity) {
      if (entity.hasVehicle()) {
        ...
        // Dynamic detection of Ramal and ShapeId
        String richLine = line;
        String shapeId = '';
        final String tripIdStr = tripId?.toLowerCase() ?? '';
        final String routeIdStr = routeId.toLowerCase();
        
        if (line == '159') {
          if (tripIdStr.contains('azul') || routeIdStr.contains('azul') || tripIdStr.contains('_c') || routeIdStr.contains('_c')) {
            richLine = '159 - L Azul (Alpargatas)';
            shapeId = '159_azul_shape';
          } else if (tripIdStr.contains('roja') || routeIdStr.contains('roja') || tripIdStr.contains('_d') || routeIdStr.contains('_d')) {
            richLine = '159 - L Roja (Alpargatas)';
            shapeId = '159_roja_shape';
          } else if (tripIdStr.contains('ramal 2') || tripIdStr.contains('esp') || tripIdStr.contains('_b') || routeIdStr.contains('_b')) {
            richLine = '159 - Ramal 2 (Villa España)';
            shapeId = '159_r2_shape';
          } else {
            richLine = '159 - Ramal 1 (Cruce Varela)';
            shapeId = '159_r1_shape';
          }
        } else if (line == '98') {
          if (tripIdStr.contains('r3') || tripIdStr.contains('lisandro') || tripIdStr.contains('_a') || routeIdStr.contains('_a')) {
            richLine = '98 - Ramal 3 (Lisandro de la Torre)';
            shapeId = '98_r3_shape';
          } else {
            richLine = '98 - Ramal 5 (Av. Mitre)';
            shapeId = '98_r5_shape';
          }
        }
  ...
  List<TransitVehicle> _simulateProfessionalMovement() {
    ...
    return [
      _createSimulatedVehicle('sim_98_r3', '98 - Ramal 3 (Lisandro de la Torre)', _routeR3, indexR3, t, 'Once - Berazategui (Lisandro de la Torre)', 120, '98_r3_shape'),
      _createSimulatedVehicle('sim_98_r5', '98 - Ramal 5 (Av. Mitre)', _routeR5, indexR5, t, 'Once - Berazategui (Av. Mitre)', 0, '98_r5_shape'),
      _createSimulatedVehicle('sim_159_r1', '159 - Ramal 1 (Cruce Varela)', _route159R1, indexR1, t, 'Cruce Varela', 60, '159_r1_shape'),
      _createSimulatedVehicle('sim_159_r2', '159 - Ramal 2 (Villa España)', _route159R2, indexR2, t, 'Villa España', 120, '159_r2_shape'),
      _createSimulatedVehicle('sim_159_azul', '159 - L Azul (Alpargatas)', _route159Azul, indexAzul, t, 'Alpargatas', 180, '159_azul_shape'),
      _createSimulatedVehicle('sim_159_roja', '159 - L Roja (Alpargatas)', _route159Roja, indexRoja, t, 'Alpargatas', 240, '159_roja_shape'),
    ];
  }

  TransitVehicle _createSimulatedVehicle(String id, String line, List<LatLng> route, int index, double t, String dest, int? delay, String shapeId) {
    if (route.isEmpty) {
      return TransitVehicle(
        id: id,
        line: line,
